...
- Κατά την αναζήτηση ο χρήστης θα μεταβαίνει στην σελίδα "Αποτελέσματα Αναζήτησης"
...
- Ο χρήστης θα μπορεί να αλλάξει τις ημερομηνίες Check-in και Check-out (ημερολόγιο) και θα ανανεώνεται η σελίδα του δωματίου καθώς και η ένδειξη εάν είναι κρατημένο ή όχι
